...
namespace WeatherApp
{
    ...
    {
        private readonly UILabel lblCity;
        private readonly UILabel lblHigh;
        private readonly UILabel lblLow;
        readonly UIImageView imgWeather;
        protected internal WeatherCell(IntPtr handle) : base(handle)
        {
